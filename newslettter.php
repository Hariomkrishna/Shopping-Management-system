					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/krishna.srivastava.7739"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/Krishna94443503"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/krish_340/"><i class="fa fa-instagram"></i></a>
								</li>
